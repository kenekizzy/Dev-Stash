...
- Use Feature folders for organizing components and related code
- Always use feature folders for organizing components and related code.
- Never create a new folder directly inside the components folder.
